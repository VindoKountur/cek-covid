...
export const DataProvider = (props) => {
  ...
  const realUrlProvinsi = "https://make-life-easier.herokuapp.com/api/covid/provinsi";
  const [data, setData] = useState({});
  const [dataProvinsi, setDataProvinsi] = useState([]);

  const fetchData = () => {
    axios.get(realUrlInd)
      .then(res => {
  ...
  return (
    <DataContext.Provider value={[data, setData, dataProvinsi, setDataProvinsi]}>
      {props.children}
